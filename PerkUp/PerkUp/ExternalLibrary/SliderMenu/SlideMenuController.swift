...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = SizeUtil.convertIphone6ToIphone5(270)
...
public class SlideMenuController: UIViewController, UIGestureRecognizerDelegate,UINavigationControllerDelegate {
    ...
    private func setUpViewController(targetView: UIView, targetViewController: UIViewController?) {
        if let viewController = targetViewController {
            ...
            viewController.navigationController?.navigationBar.barStyle = UIBarStyle.BlackTranslucent
        }
    }
...
extension UIViewController {
    ...
    public func addLeftBarButtonWithImage(buttonImage: UIImage) {
        ...
        leftButton.addTarget(self, action: #selector(UIViewController.toggleLeft), forControlEvents: UIControlEvents.TouchUpInside)
